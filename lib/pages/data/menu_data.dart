final Map<String, dynamic> menuData = {
  ...
  "Food": {
    "Breakfast": {
      "Astro Breakfast": [
        {
          "name": "Astro Breakfast A",
          "price": 229,
          "description": "Hot Coffee & Orange Juice",
          "priceOptions": [
            {"label": "Set (พร้อมกาแฟ+น้ำส้ม)", "price": 229},
            {"label": "A la carte (ไม่รวมเครื่องดื่ม)", "price": 180},
          ],
        ...
        },
        {
          ...
          "description": "Hot Coffee & Orange Juice",
          "priceOptions": [
            {"label": "Set (พร้อมกาแฟ+น้ำส้ม)", "price": 285},
            {"label": "A la carte (ไม่รวมเครื่องดื่ม)", "price": 255},
          ],
      ...
      "Topping": [
        {"name": "Parmesan cheese", "price": 30, "isTopping": true},
        {"name": "Toast", "price": 30, "isTopping": true},
        {"name": "Sausage", "price": 30, "isTopping": true},
        {"name": "Scramble eggs", "price": 90, "isTopping": true},
      ],
    },
    "Salad": {
      "Astro House Salad": [
      ...
      "Topping": [
        {"name": "Bacon block", "price": 60, "isTopping": true},
        {"name": "Avocado", "price": 100, "isTopping": true},
        {"name": "Ham", "price": 40, "isTopping": true},
        {"name": "Tuna", "price": 60, "isTopping": true},
        {"name": "Strawberry", "price": 30, "isTopping": true},
        {"name": "Bacon slide", "price": 35, "isTopping": true},
        {"name": "Chicken", "price": 50, "isTopping": true},
      ],
    },
    "Sandwich": {
      "Hot Sandwich": [
        ...
        {
          "name": "Sandwich Egg",
          "description": "Egg Hot Sandwich 125฿ / Ham & Egg Hot sandwich 145฿",
          "price": 125,
          "priceOptions": [
      ...
      "Topping": [
        {"name": "Mozzarella cheese", "price": 65, "isTopping": true},
        {"name": "Toast", "price": 30, "isTopping": true},
        {"name": "Sausage", "price": 30, "isTopping": true},
        {"name": "Scramble eggs", "price": 90, "isTopping": true},
      ],
    ...
    "Toast": {
      ...
      "Topping": [
        ...
        {"name": "Toast", "price": 30, "isTopping": true},
        {"name": "Sausage", "price": 30, "isTopping": true},
        {"name": "Scramble eggs", "price": 60, "isTopping": true},
      ],
    },
    "Roti": {
      "Special Roti": [
      ...
      "Topping": [
        {"name": "Tuna", "price": 60, "isTopping": true},
        {"name": "Mozzarella cheese", "price": 65, "isTopping": true},
        {"name": "Bacon/Ham", "price": 60, "isTopping": true},
        {"name": "Beef", "price": 65, "isTopping": true},
      ],
    },
    "Pizza": {
      "Special Pizza": [
      ...
      "Topping": [
        {"name": "Mozzarella cheese", "price": 85, "isTopping": true},
        {"name": "Bacon/Ham", "price": 60, "isTopping": true},
      ],
    },
    "Spaghetti": {
      ...
      "Topping": [
        {"name": "Parmesan cheese", "price": 30, "isTopping": true},
        {"name": "shrimp", "price": 65, "isTopping": true},
        {"name": "Bacon/Ham", "price": 60, "isTopping": true},
      ],
    },
    "Gratin": {
      ...
      "Topping": [
        {"name": "Bacon", "price": 60, "isTopping": true},
        {"name": "shrimp", "price": 65, "isTopping": true},
      ],
    },
    "Appetizer": {
      "Special Appetizer": [
        ...
        {
          "name": "Fried Gyoza",
          "description": "6 piece 140฿ / 9 piece 180฿",
          "price": 140,
          "priceOptions": [
    ...
    "Steak": {
      ...
      "Topping": [
        {"name": "Bacon slide", "price": 35, "isTopping": true},
        {"name": "mozzarella cheese", "price": 65, "isTopping": true},
        {"name": "Parmesan cheese (Skillet)", "price": 30, "isTopping": true},
      ],
      "Additional": [
        {"name": "Mushroom sauce", "price": 45, "isTopping": true},
        {"name": "Garlic tomato sauce", "price": 45, "isTopping": true},
        {"name": "Peper sauce", "price": 45, "isTopping": true},
      ],
    },
    "Japanese": {
      "Garlic Rice Selection": [
        {
      ...
      "Thai Noodles": [
        {
          ...
          "price": 165,
          "priceOptions": [
            {"label": "chicken(ไก่)", "price": 165},
            {"label": "pork(หมู)", "price": 165},
        ...
        },
        {
          ...
          "price": 150,
          "priceOptions": [
            {"label": "seafood(ทะเล)", "price": 180},
            {"label": "chicken(ไก่)", "price": 150},
      ...
      "Thai Rice": [
        {
          ...
          "price": 145,
          "priceOptions": [
            {"label": "seafood(ทะเล)", "price": 165},
            {"label": "shrimp(กุ้ง)", "price": 165},
            {"label": "chicken(ไก่)", "price": 145},
            {"label": "pork(หมู)", "price": 145},
            {"label": "sourpork(แหนม)", "price": 145},
            {"label": "eggs(ไข่)", "price": 145},
